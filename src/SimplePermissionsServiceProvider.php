...
class SimplePermissionsServiceProvider extends ServiceProvider
{
    ...
    protected function configurePublishing(): void
    {
        ...
        $migrations = [
            ...
            __DIR__ . '/../database/migrations/create_permission_user_table.php' => database_path('migrations/2019_12_14_000005_create_permission_user_table.php'),
            __DIR__ . '/../database/migrations/create_entity_permission_table.php' => database_path('migrations/2019_12_14_000006_create_entity_permission_table.php'),
        ];

        // Add abilities migrations if enabled
        if (Config::get('simple-permissions.features.abilities.enabled', true)) {
            $migrations[__DIR__ . '/../database/migrations/create_abilities_table.php'] = database_path('migrations/2019_12_14_000007_create_abilities_table.php');
            $migrations[__DIR__ . '/../database/migrations/create_entity_ability_table.php'] = database_path('migrations/2019_12_14_000008_create_entity_ability_table.php');
        }

        // Add groups migrations if enabled
        if (Config::get('simple-permissions.features.groups.enabled', true)) {
            $migrations[__DIR__ . '/../database/migrations/create_groups_table.php'] = database_path('migrations/2019_12_14_000009_create_groups_table.php');
            $migrations[__DIR__ . '/../database/migrations/create_group_user_table.php'] = database_path('migrations/2019_12_14_000010_create_group_user_table.php');
        }
        ...
        $migrations[__DIR__ . '/../database/migrations/add_performance_indexes.php'] = database_path('migrations/2019_12_14_000012_add_performance_indexes.php');
